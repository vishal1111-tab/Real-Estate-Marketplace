    ...
    <main>
      ...
      {listing && !loading && !error && (
        <div>
          ...
          <div className=" content flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4">
            ...
            <ul className="text-red-600 font-semibold text-xl flex flex-wrap items-center gap-4 sm:gap-6 ">
